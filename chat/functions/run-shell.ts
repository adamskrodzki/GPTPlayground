...
export class RunShellFunction extends ChatCompletionFunctionBase<
  RunShellFunctionParameters,
  RunShellFunctionResult
> {
  protected executeImplementation(
    parameters: RunShellFunctionParameters,
  ): Promise<ChatCompletionFunctionExecutionResult<RunShellFunctionResult>> {

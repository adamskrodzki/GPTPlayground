...
export class RequiredToolsFunction extends ChatCompletionFunctionBase<RequiredToolsFunctionParameters, RequiredToolsFunctionResult>  {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    protected executeImplementation(_parameters: RequiredToolsFunctionParameters): Promise<ChatCompletionFunctionExecutionResult<RequiredToolsFunctionResult>> {
    ...
    public description = 'Allows AI agent to inform other AI agents about the tools that are required to accomplish the task. If function works correctly, it should respond with "Tools selected"';

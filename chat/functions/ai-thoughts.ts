...
export class AIThoughtsFunction extends ChatCompletionFunctionBase<
  AIThoughtsFunctionParameters,
  AIThoughtsFunctionResult
> {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  protected executeImplementation(
    _parameters: AIThoughtsFunctionParameters,
  ): Promise<ChatCompletionFunctionExecutionResult<AIThoughtsFunctionResult>> {

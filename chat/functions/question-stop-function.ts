...
const questionStopFunctionDescription =
  'Allows AI agent inform user that he came up with final answer and what the answer is. \
...
export class QuestionStopFunction extends ChatCompletionFunctionBase<
  QuestionStopFunctionParameters,
  QuestionStopFunctionResult
> {
  protected executeImplementation(
    parameters: QuestionStopFunctionParameters,
  ): Promise<
    ChatCompletionFunctionExecutionResult<QuestionStopFunctionResult>
  > {
...
export { questionStopFunctionInstance, questionStopFunctionDescription };
